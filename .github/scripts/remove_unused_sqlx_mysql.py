...
old = 'sqlx = { version = "0.8", default-features = false, features = ["runtime-tokio-rustls", "sqlite", "postgres", "chrono", "uuid", "json", "derive"] }'
new = 'sqlx = { version = "0.8", default-features = false, features = ["runtime-tokio-rustls", "sqlite", "postgres", "chrono", "uuid", "json"] }'
if old in text:
    text = text.replace(old, new, 1)
elif new not in text:
    raise SystemExit("workspace sqlx dependency marker not found")
